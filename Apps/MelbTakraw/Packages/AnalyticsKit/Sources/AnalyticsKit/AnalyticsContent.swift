...
public struct AnalyticsContent: UIViewRepresentable {
    ...
    public func makeUIView(context: Context) -> WKWebView {
        ...
        let webView = WKWebView(frame: .zero, configuration: AnalyticsFactory.makeConfiguration(enableLiveMediaSupport: true))
        ...
        let startURL = context.coordinator.sessionStore.savedURL(forEntryURL: config.initialURL) ?? config.initialURL
        context.coordinator.sessionStore.save(entryURL: config.initialURL)
    ...
    public final class Coordinator: NSObject, WKNavigationDelegate, WKUIDelegate, UIDocumentPickerDelegate {
        ...
        fileprivate let sessionStore: AnalyticsSessionStore
